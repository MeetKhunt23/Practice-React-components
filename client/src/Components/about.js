...
export default function About() {
  ...
  return (
    <div classNameName="container my-4 p-3" style={mystyle}>
      <h2 className="p-8">About Us</h2>
      ...
      <div classNameName="contaienr my-3 "></div>
      <button onClick={togglestate} classNameName="btn btn-primary">{btntext}</button>
    </div>
  );
}
