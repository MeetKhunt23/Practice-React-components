...
const Inputfiels = (props) => {
  ...
  const savechangeandclose = async() => {
    var title=document.getElementById("name").value ? document.getElementById("name").value : name
    setName(title)
    var placeholderr=document.getElementById("placeholder").value ? document.getElementById("placeholder").value : placeholder 
